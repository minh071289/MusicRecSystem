...
import { FaTimes } from 'react-icons/fa'; // Nhớ cài react-icons rồi nhé
import { usePlayer } from '../contexts/PlayerContext';

export default function Player() {
  const { currentItem, closePlayer } = usePlayer(); // Lấy hàm closePlayer

  if (!currentItem) return null;

  // Logic tạo link embed Spotify
  ...
  return (
    <div className="fixed bottom-16 md:bottom-0 left-0 right-0 z-50 px-2 pb-1 md:pb-0 animate-slide-up">
      ...
      {/* Container chứa Player - Thêm relative để nút X định vị theo khung này */}
