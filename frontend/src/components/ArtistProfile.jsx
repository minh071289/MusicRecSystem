        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {data.bio && (
                <div className="mb-10">
                  <h2 className="text-2xl font-bold text-white mb-6">About {data.name || artist.title}</h2>
                  <div 
            ...
            <div className="lg:col-span-1 relative">
              <div className="sticky top-24 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-gray-400 uppercase tracking-wider bg-[#333] px-2 py-1 rounded">Latest Release</span>
                </div>
          ...
          <div className="text-center text-red-400 p-10 border border-red-900/30 bg-red-900/10 rounded-xl">
            Could not load artist data. Please try again later.
          </div>
        )}
      </div>
    </div>
