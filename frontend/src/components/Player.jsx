...
export default function Player() {
  ...
  return (
    ...
    <div className="fixed bottom-16 md:bottom-0 left-0 md:left-64 right-0 z-50 px-2 pb-1 md:pb-0 animate-slide-up">

      <div className="relative bg-black border-t border-[#282828] md:rounded-t-xl overflow-visible shadow-[0_-4px_10px_rgba(0,0,0,0.5)]">
